...
const FormGeneration = () => {
  return (
    <>
      ...
      {/* Main workspace shell filling remaining screen real estate seamlessly */}
      {/* flex-1 lets this grow to fill the screen below the TitleBar, min-h-0 freezes the height boundary */}
      <div className="flex-1 w-full flex relative min-h-0 overflow-hidden">

        {/* Canvas Area (Left Side) */}
        {/* Removing h-full and using flex-1 with min-h-0 lets the container handle its own scrollable viewport perfectly */}
        ...
        {/* shrink-0 ensures the sidebar maintains its exact width; min-h-0 clamps the viewport height */}
